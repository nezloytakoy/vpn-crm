  ...
  try {
    ...
    if (payment && userId) {
      ...
      if (referral) {
        ...
        await sendLogToTelegram(`Referral found for User ${decodedUserId}. User ${referral.userId} receives ${referralCoins} coins`);
        ...
        await sendLogToTelegram(`No referral found for User ${decodedUserId}`);
      }
