...
export const translations = {
  ru: {
    ...
    requests_increased: "Вам выдано запросов: %count% ",
    requests_decreased: "У вас уменьшились запросы на %count%",
  ...
  en: {
    ...
    requests_increased: "You have been granted %count% new requests",
    requests_decreased: "Your requests have been decreased by %count%",
