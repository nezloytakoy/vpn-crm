...
export async function handleAssistantLastMessage(conversation: any) {
...
export async function handleUserLastMessage(conversation: any) {
...
async function remindAssistant(conversation: any) {
  ...
  async function handleIgnoredConversation(conversation: any) {
